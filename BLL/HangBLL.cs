...
namespace BLL
{
    ...
    public class HangBLL
    {
        ...
        public Hang LayHang(DataGridView data)
        {
            ...
            hang.DonGia = decimal.Parse(row.Cells["DonGia"].Value.ToString());
            ...
            hang.MaNCC = int.Parse(row.Cells["MaNCC"].Value.ToString());
            hang.MaLoai = int.Parse(row.Cells["MaLoai"].Value.ToString());
